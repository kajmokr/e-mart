...
emart.directive('starRating2', function () {
    // source: http://stackoverflow.com/questions/23646395/rendering-a-star-rating-system-using-angularjs
    return {
        restrict: 'A',
        template: '<ul class="rating">' +
        '<li ng-repeat="star in stars" ng-class="star">' + '\u2605' + '</li>'
        + '</ul>',
        scope: {
            ratingValue: '=',
            max: '='
...
emart.directive('starRating3', function () {
    return {
        restrict: 'A',
        template: '<ul class="rating">' +
...
emart.directive('clockpicker', ['$timeout', '$parse', function ($timeout, $parse) {
    return {
        restrict: 'C',
        require: 'ngModel',
